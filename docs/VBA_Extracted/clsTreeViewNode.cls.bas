' Module: clsTreeViewNode.cls
' Type: Standard Module
' Stream Path: VBA/clsTreeViewNode
' =========================================================

Attribute VB_Name = "clsTreeViewNode"
...
Private moParentNode As clsTreeViewNode
Private moLastActiveNode As clsTreeViewNode
...
Public Property Get Child() As clsTreeViewNode
...
Public Property Get FirstSibling() As clsTreeViewNode
    If Not moParentNode Is Nothing Then    ' PT Root has no parent
        Set FirstSibling = moParentNode.GetChild(1)
    End If
End Property

Public Property Get LastSibling() As clsTreeViewNode
    If Not moParentNode Is Nothing Then    ' PT Root has no parent
...
Public Property Get NextNode() As clsTreeViewNode    ' can't name this proc 'Next' in VBA
...
Public Property Get ParentNode() As clsTreeViewNode
    Set ParentNode = moParentNode
End Property

Public Property Set ParentNode(oParentNode As clsTreeViewNode)
    Set moParentNode = oParentNode
End Property

Public Property Get Previous() As clsTreeViewNode
...
Public Property Get Root() As clsTreeViewNode
    Dim cTmp As clsTreeViewNode
    Set cTmp = Me
...
Public Function AddChild(Optional skey As String, _
    ...
    On Error GoTo errH
    Set cChild = New clsTreeViewNode
...
Public Function GetChild(vKey As Variant) As clsTreeViewNode
'-------------------------------------------------------------------------
' Procedure : GetChild
' Company   : JKP Application Development Services (c)
' Author    : Jan Karel Pieterse (www.jkp-ads.com)
...
Friend Function RemoveChild(cNode As clsTreeViewNode, Optional bReverse As Boolean) As Boolean
...
' default properties
    ...
    #If DebugMode = 1 Then
        gclsTreeViewNodeInit = gclsTreeViewNodeInit + 1    ' PT, for testing only, remove, see ClassCounts() in modDemo
    #End If
End Sub

Private Sub Class_Terminate()
    #If DebugMode = 1 Then
        gclsTreeViewNodeTerm = gclsTreeViewNodeTerm + 1    ' PT, for testing,
    #End If
    Set moTree = Nothing
End Sub
