...
' Stream Path: VBA/frmAudit
' =========================================================

Attribute VB_Name = "frmAudit"
Attribute VB_Base = "0{BFBA4DDD-89FD-4AE0-99F7-F90BD8873497}{58655497-EFB2-48F6-8A3E-12D3EA7AADD7}"
    ...
    If CheckBox_DisplayAccountValue_02_75 Then
        tempSQL = tempSQL & "TRAD_CV AS ( "
            tempSQL = tempSQL & "SELECT "
                ...
                tempSQL = tempSQL & ", (CASE WHEN COVERAGE1.LOW_DUR_1_CSV_AMT IS NULL THEN 0 ELSE COVERAGE1.LOW_DUR_1_CSV_AMT END)*COVERAGE1.COV_UNT_QTY*INTERPOLATION_MONTHS.MONTHS_TO_NEXT_ANN + (CASE WHEN COVERAGE1.LOW_DUR_2_CSV_AMT IS NULL THEN 0 ELSE COVERAGE1.LOW_DUR_2_CSV_AMT END)*COVERAGE1.COV_UNT_QTY*INTERPOLATION_MONTHS.MONTHS_YTD INTERP_CV "
                tempSQL = tempSQL & ", (CASE WHEN COVERAGE1.LOW_DUR_NSP_AMT IS NULL THEN 0 ELSE COVERAGE1.LOW_DUR_NSP_AMT END)*COVERAGE1.COV_UNT_QTY*INTERPOLATION_MONTHS.MONTHS_TO_NEXT_ANN + (CASE WHEN COVERAGE1.LOW_DUR_1_NSP_AMT IS NULL THEN 0 ELSE COVERAGE1.LOW_DUR_1_NSP_AMT END)*COVERAGE1.COV_UNT_QTY*INTERPOLATION_MONTHS.MONTHS_YTD INTERP_NSP "
