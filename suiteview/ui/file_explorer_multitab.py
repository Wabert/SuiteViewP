    ...
    def _open_task_tracker(self):
        ...
        if self.task_tracker_window is None:
            try:
                ...
                return
        self.task_tracker_window.show()
        self.task_tracker_window.activateWindow()
        self.task_tracker_window.raise_()
    ...
    def _open_polview(self):
        ...
        if self.polview_window is None:
            try:
                ...
                return
        self.polview_window.show()
        self.polview_window.activateWindow()
        self.polview_window.raise_()
    ...
    def _open_abrquote(self):
        ...
        if self.abrquote_window is None:
            try:
                ...
                return
        self.abrquote_window.show()
        self.abrquote_window.activateWindow()
        self.abrquote_window.raise_()
    ...
    def _open_rate_manager(self):
        ...
        if self.ratemanager_window is None:
            try:
                ...
                return
        self.ratemanager_window.show()
        self.ratemanager_window.activateWindow()
        self.ratemanager_window.raise_()
